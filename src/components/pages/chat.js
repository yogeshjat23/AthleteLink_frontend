...
function Chat({ teamId, teamMembers }) {
  ...
  if (!session) {
    return (
      <div className="chat-container"> 
        <p style={{ color: "red" }}>
          Sign in with Google to chat. Please sign in with the same email used to join this team.
        </p> 
  ...
  if (!isUserInTeam) {
    return (
      <div className="chat-container">
        <p style={{ color: "red" }}>
          You must be a team member to see and send messages. Please sign in with the same email used to join this team.
        </p>  
        <button onClick={signIn}>Sign in</button>
      </div>
    );
